...
$person                = Alumno::find($user->alumno_id);
?>
<!-- Begin page -->
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="seguimiento" class="logo"><i class="md md-equalizer"></i> <span>Seguimiento UNPRG</span> </a>
                    </div>
                </div>
            ...
            <!-- ========== Left Sidebar Start ========== -->
            @include('seguimiento.left_sidebar')
            <!-- Left Sidebar End -->
