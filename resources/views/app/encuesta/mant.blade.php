...
<div class="form-group">
	{!! Form::label('objetivo', 'Objetivo:', array('class' => 'col-lg-3 col-md-3 col-sm-3 control-label')) !!}
	<div class="col-lg-9 col-md-9 col-sm-9">
		{!! Form::textarea('objetivo', null, array('class' => 'form-control input-xs', 'id' => 'objetivo', 'placeholder' => 'Ingrese objetivo')) !!}
	</div>
</div>
<div class="form-group">
