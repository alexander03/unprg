    ...
    */
    ...
    public function login(Request $request) {
        ...
        if ($this->guard()->validate($this->credentials($request))) {
            ...
            if (($user->usertype_id == 1 || $user->usertype_id == 2 || $user->usertype_id == 5) && $this->attemptLogin($request)) {
                ...
                return redirect()
                    ...
                    ->withErrors(['active' => 'Estas credenciales no coinciden con nuestros registros.']);
            }
        }
