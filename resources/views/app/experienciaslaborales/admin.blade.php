        ...
        <div class="card-box table-responsive">
            <div class="row m-b-30">
                <div class="col-sm-12">
					...
					<a href="{{ route('generarcurriculum')}}" class="btn btn-info waves-effect waves-light m-l-10 btn-md" target="_blank"><i class="glyphicon glyphicon-save-file"></i> Mi Currículum</a>
					{!! Form::close() !!}
		 		</div>
            </div>
